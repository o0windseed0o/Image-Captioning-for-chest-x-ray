...
class Config(object):
    ...
    def __init__(self):
        ...
        self.vocabulary_size = 400


        # about the training
        self.train_image_dir = './train/images/'
        self.train_caption_file = './train/mesh_train.json' #'./train/impression_train.json'
        self.temp_annotation_file = './train/anns.csv'
        self.temp_data_file = './train/data.npy'
        self.lda_csv = './train/35words_mapping.csv' # used for LDA

        # about the evaluation
        self.eval_image_dir = './val/images/'
        self.eval_caption_file = './val/mesh_val.json' #'./train/impression_val.json'
